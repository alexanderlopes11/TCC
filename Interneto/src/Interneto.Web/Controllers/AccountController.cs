...
using Interneto.Sessions;
using Interneto.Web.Controllers.Results;
using Interneto.Web.Models;
using Interneto.Web.Models.Account;
...
{
    public class AccountController : InternetoControllerBase
    {
